class Character extends MovableObject {
    ...
    constructor() {
        ...
        this.climbingSprite.onload = () => {
            console.log('Climbing sprite loaded');
        };
    ...
    // ✅ GRAVITY IMMER HIER - ganz am Anfang!
    if (!this.isDead) {
        this.applyGravity();
    }
    ...
    if (!this.isDead) {
        ...
        // 2. Hurt Check
            ...
            if (this.world && this.world.keyboard) {
                ...
                // Movement
                if ((this.world.keyboard.RIGHT || this.world.keyboard.LEFT) && !this.isClimbing) {
                this.isWalking = true;
                ...
                if (this.world.keyboard.SPACE && !this.spaceKeyPressed && !this.isAttacking && !this.isJumping && !this.isClimbing) {
                ...
                if (this.world.keyboard.W || this.world.keyboard.DOWN) {
                    this.speedY = 0; // Keine Gravity während klettern
                    this.isClimbing = true;
                    this.jumping = false; // Verhindert Jump Animation
                    this.climbLadder();
                }
    ...
    climbLadder() {
        ...
        for (let ladder of this.world.level.ladders) {
            if (this.x + this.width/2 > ladder.x && 
                ...
                this.isClimbing = true;
                this.speedY = 0; // Keine Gravity während klettern
                this.isWalking = false; // Verhindert Walk Animation
